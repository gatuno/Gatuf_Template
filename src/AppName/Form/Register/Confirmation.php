 ...
 *
 */
class APP_CAMEL_CASE_Form_Register_Confirmation extends Gatuf_Form {
	public $_user = null;
	...
	public function clean_key() {
		...
		if (false === ($email_id = APP_CAMEL_CASE_Form_Register_InputKey::checkKeyHash($this->cleaned_data['key']))) {
	...
	function save($commit=true) {
		...
		if ($commit) {
			...
			Gatuf_Signal::send('Gatuf_User::passwordUpdated',
							  'APP_CAMEL_CASE_Form_Register_Confirmation', $params);
		}
		return $this->_user;
	}
}
